...
def gather_user_input():
    ...
    products_can_be_sold = validate_input(
        "Products can be sold (y/n): ", ['y', 'n'])
...
while True:
    ...
    create_product_group(group_name, group_id, domestic_vat, vat_eu,
                         vat_abroad, vat_domestic_taxfree, has_inventory, products_can_be_sold)
